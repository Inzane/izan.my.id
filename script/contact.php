...
/* ReCaptch Secret */
$recaptchaSecret = '6LfVlQ8jAAAAAMP8dIWFL4tpCNb0HLPcEkvHnG2H';

$dzEmailTo 		= "erlambang@consultant.com";   /* Receiver Email Address */
$dzEmailFrom    = "i-can Contact";
...
try {
    if (!empty($_POST)) {
		...
		if($_POST['dzToDo'] == 'Contact')
		{
			...
			$dzMailSubject = 'i-can|Contact Form: A Person want to contact';
			$dzMailMessage	= 	"
		...
		if($_POST['dzToDo'] == 'Appointment')
		{
			...
			$dzMailSubject = 'i-can|Appointment Form: A Person want to contact';
			$dzMailMessage	= 	"
								A person want to contact you: <br><br>
								Name: $dzName<br/>
								Email: $dzEmail<br/>
